...
// var TMS2 = new TM.ScreenManager(screenSetting2),
//     TMI2 = new TM.InputManager(screenSetting2.canvasId,debugSetting.devMode),
//     TMD2 = new TM.DebugManager(debugSetting);


var NUM_OF_ROW = 4;
var NUM_OF_COLUMN = 4;
var NUM_OF_INITIAL_BLOCK = 1;
var BOARD_HEIGHT = NUM_OF_ROW * 3 + 2;
var BOARD2_HEIGHT = NUM_OF_ROW * 3 + 2;
var BOARD_WIDTH = NUM_OF_COLUMN * 6 + 2;
var BOARD2_WIDTH = NUM_OF_COLUMN * 6 + 2;
var SPEED = 50;
var FRAME_X = 6;
var FRAME_Y = 1;
var COLORSET = {
...
function drawFrame() {
  ...
  var FRAME_X2 = FRAME_X + BOARD2_WIDTH + 2
  var FRAME_Y2 = FRAME_Y
  TMS.cursor.move(10,10)
  for (var i = 0; i < BOARD2_HEIGHT; i++) {
    for (var j = 0; j < BOARD2_WIDTH; j++) {
      TMS.cursor.move(FRAME_X2 + j, FRAME_Y2 + 3 + i);
      if (i == 0 && j == 0) TMS.insertText('┌');
      else if (i == 0 && j == BOARD2_WIDTH - 1) TMS.insertText('┐');
      else if (i == BOARD2_HEIGHT - 1 && j == 0) TMS.insertText('└');
      else if (i == BOARD2_HEIGHT - 1 && j == BOARD2_WIDTH - 1) TMS.insertText('┘');
      else if (i == 0 || i == BOARD2_HEIGHT - 1) TMS.insertText('─');
      else if (j == 0 || j == BOARD2_WIDTH - 1) TMS.insertText('|');
    }
  }


    var x = FRAME_X + BOARD_WIDTH - 10;
    var y = FRAME_Y;
